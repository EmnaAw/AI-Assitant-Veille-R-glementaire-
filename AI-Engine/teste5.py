...
# --- CONFIGURATION (MULTILINGUAL-E5 VERSION) ---
# intfloat/multilingual-e5-base is the specific identifier for this model
MODEL_NAME = "intfloat/multilingual-e5-base"
DB_DIR = "./db_multilingual_e5" 
...
def run_single_test():
    ...
    for test in TEST_QUERIES:
        # CRITICAL: E5 requires 'query: ' prefix for asymmetric retrieval
        query_text = f"query: {test['q']}"
        results = hybrid_search(query_text, vector_db)
