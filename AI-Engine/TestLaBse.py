...
# --- CONFIGURATION (LaBSE VERSION) ---
MODEL_NAME = "sentence-transformers/LaBSE"
DB_DIR = "./db_labse" 
FILES = ["data/Articles.txt", "data/Lois.txt", "data/Termesjuridiques.txt"]

# Shared parameters to ensure scientific fairness across all models
...
def run_single_test():
    ...
    # 4. INITIALIZE LABSE MODEL WITH STANDARD PARAMETERS
    ...
    print("\n" + "="*50)
    print(f"📊 STANDARDIZED METRICS FOR {MODEL_NAME}")
