...
PHRASE_REPLACEMENTS = (
    ...
    (r"\bmecin\b", "medecin"),
    (r"\bmedcin\b", "medecin"),
    (r"\bequipe securite\b", "equipe de securite"),
    (r"\bequipe de securite\s+nest pas forme\w*\b", "equipe de securite insuffisamment formee"),
    (r"\bequipe de securite\s+pas forme\w*\b", "equipe de securite insuffisamment formee"),
